...
import { Header, SkeletonCards } from "../Components/Skeletons";
...
const Todo = () => {
    ...
    const filteredTodo = todo.filter((item) => {
        if (selectedTag === "all" && searchQuery === "") {
            ...
            return (
                item.status === "pending" && item.title.includes(searchQuery)
            );
        } else if (selectedTag === "completed") {
            return (
                item.status === "completed" && item.title.includes(searchQuery)
            );
        } else {
